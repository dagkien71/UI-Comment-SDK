...
class CommentManager {
    ...
    async changeCommentStatus(commentId, status) {
        ...
        if (status === CommentStatus.DONE &&
            previousStatus !== CommentStatus.DONE) {
            comment.resolvedAt = new Date().toISOString();
        }
        else if (status === CommentStatus.ARCHIVED &&
...
export { CommentSDK, CommentStatus, CommentStorage, HybridCommentStorage, LocalStorageManager, LocalUserProfileStorage, ProfileSettingsModal, SettingsButton, VERSION, createHybridStorageConfig, index as default, hybridStorageUtils, initCommentSDK, localStorageUtils, userProfileStorage };
